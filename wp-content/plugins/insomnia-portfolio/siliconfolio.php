<?php
/**
* Plugin Name: SiliconFolio Insomnia Edition
...
function extra_fields_plugins() {
  add_meta_box( 'extra_fields_plugin', 'Additional settings', 'extra_fields_for_portfolio', 'portfolio', 'normal', 'low'  );
  add_meta_box( 'extra_fields_plugin', 'Portfolio settings', 'extra_fields_for_pages_plugin', 'page', 'normal', 'low'  );
}
