 ...
 */
add_action('widgets_init', 'insomnia_load_popular_post_widgets');

function insomnia_load_popular_post_widgets()
{
	register_widget('insomnia_Popular_Posts_Widget');
}
 ...
 *
 */
	class insomnia_Popular_Posts_Widget extends WP_Widget {

	/**
	 * Widget setup.
	 */		
	function insomnia_Popular_Posts_Widget() {
		
		/* Widget settings. */
		$widget_ops = array('classname' => 'insomnia_popular_post_widget', 'description' => __( 'Displays popular posts from blog.', 'insomnia' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'insomnia_popular_post_widget' );

		/* Create the widget. */		
		$this->__construct( 'insomnia_popular_post_widget', 'Insomnia: Popular Posts ', $widget_ops);
	}
...
function widget( $args, $instance ) {
	...
	$args = array( 
		...
		'orderby' => 'meta_value',
		'meta_key' => 'insomnia_post_views_count',
...
function form( $instance ) {
	...
	$defaults = array( 'title' => __( 'Popular Posts' , 'insomnia' ), 'number_of_posts_to_show' => '3' );
