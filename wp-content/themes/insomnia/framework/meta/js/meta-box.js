...
jQuery(document).ready(function($) {
    ...
    // link to link
  if($("select[name='insomnia_portf_icon'] option:selected").val() == 'link_to_link') {
    $("#insomnia_portf_link").show();
  }

    $('select[name="insomnia_portf_icon"]').on("change", function(event){
      var str = '';
      str = $("select[name='insomnia_portf_icon'] option:selected").val();

     if(str == 'link_to_link')
         $("#insomnia_portf_link").fadeIn();
      else
          $("#insomnia_portf_link").hide();
       
    }); 

    // link to image gallery lightbox
  if($("select[name='insomnia_portf_icon'] option:selected").val() == 'lightbox_to_gallery') {
    $("#insomnia_portf_gallery").show();
  }
    ...
    $('select[name="insomnia_portf_icon"]').on("change", function(event){
     ...
     if(str == 'lightbox_to_gallery')
         $("#insomnia_portf_gallery").fadeIn();
      else
          $("#insomnia_portf_gallery").hide();
       
    });   

    // link to video in lightbox
  if($("select[name='insomnia_portf_icon'] option:selected").val() == 'lightbox_to_video') {
    $("#insomnia_portf_video").show();
  }
    ...
    $('select[name="insomnia_portf_icon"]').on("change", function(event){
     ...
     if(str == 'lightbox_to_video')
         $("#insomnia_portf_video").fadeIn();
      else
          $("#insomnia_portf_video").fadeOut();
       
    });      


  if($("#insomnia_portfolio_navigation input[value='no-filter']:checked").val() == 'no-filter') {
    $("#insomnia_nav_number").show();
  }  

    $('input[name="insomnia_portfolio_navigation"]').on("change", function(event){
      var str = '';
      str = $("#insomnia_portfolio_navigation input[value='no-filter']:checked").val();

     if(str == 'no-filter')
         $("#insomnia_nav_number").fadeIn();
      else
          $("#insomnia_nav_number").fadeOut();
	...
	jQuery.fn.extend({
	    ShowStyles: function () {
			...
			subheader_styles['style-1'] = "#insomnia_bg_type, #insomnia_subheader_img, #insomnia_subheader_color";
			subheader_styles['style-2'] = "#insomnia_bg_type, #insomnia_subheader_img, #insomnia_subheader_color";
			subheader_styles['style-3'] = "#insomnia_bg_type, #insomnia_subheader_img, #insomnia_subheader_color";
	...
	if ((a == ('template-portfolio.php')) || (a == ('template-gallery.php')) || (a == ('template-homepage.php')) || (a == ('template-onepage.php')) ) {
		...
		jQuery('#page_sidebars #insomnia_sidebar_position').hide();
	}
	...
	jQuery.fn.extend({
	    ShowPostFormats: function () {
			...
			var post_formats = {};
			post_formats['post-format-0'] = "#insomnia_standard_post_custom_fields";
			post_formats['post-format-gallery'] = "#insomnia_gallery_post_custom_fields";
			post_formats['post-format-link'] = "#insomnia_link_post_custom_fields";
			post_formats['post-format-quote'] = "#insomnia_quote_post_custom_fields";
			post_formats['post-format-audio'] = "#insomnia_audio_post_custom_fields";
			post_formats['post-format-video'] = "#insomnia_video_post_custom_fields";
	...
	jQuery.fn.extend({
	    ShowPageFields: function () {
			...
			//page templates
			var page_templates = {};
			page_templates['template-blog.php'] = "#insomnia_blog_options";
			page_templates['template-portfolio.php'] = "#insomnia_portfolio_options";
			page_templates['template-contact.php'] = "#insomnia_contact_options";
			page_templates['template-onepage.php'] = "#insomnia_onepage_options";
...
// portfolio item hook  
  jQuery('#portf_media .repeater-table').each(function(){
