<?php $layout_value = get_theme_mod( 'insomnia_post_type' ); ?>
		...
		<?php if ( have_posts() ) : ?>
			<header class="archive-header">
				<h3 class="archive-title archive-category">Category: <?php printf( esc_html__( '%s', 'insomnia' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></h3>
...
<?php } ?>
				...
				endwhile;
					...
					echo "<p class='not-found'>" . esc_html__('Sorry, no posts in this category.', 'insomnia') . "</p>";
				endif;  		
			?>
				</div>
